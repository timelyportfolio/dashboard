...
, render: function() {
    ...
    if (this.state.submitted !== null) {
      submitted = <div className="alert alert-success"> <p>ContactForm data:</p> <pre><code>{JSON.stringify(this.state.submitted, null, '  ')}</code></pre> </div>
    }
    ...
    return <div>
      ...
      <div className="panel panel-default">
        <div className="panel-heading clearfix">
          <h3 className="panel-title pull-left">...</h3>
...
, render: function() {
    return <div className="form-horizontal">
      ...
      {this.renderRadioInlines('currentCustomer', 'Are you currently a customer?', {
        values: ['Yes', 'No']
